          ...
          <!-- borrower option -->
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#liability-pages" aria-expanded="false" aria-controls="liability-pages">
                <img src="images/icons/9.png" alt="">
                <span class="menu-title">Projects<i class="fa fa-sort-down"></i></span>
              </a>
              <div class="collapse" id="liability-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="recordsellinfo.php">Record project</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="showsellinfo.php">View Project info</a>
                  </li>
                </ul>
              </div>
            </li>
