...
<head>
	...
	<title>Uwezo Digital Management</title>
...
<body>
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="bg-white text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="index.php"><img src="images/UWEZO digital 3.png" /></a>
        <a class="navbar-brand brand-logo-mini" href="index.php"><img src="images/UWEZO digital 3.png" alt=""></a>
      </div>
