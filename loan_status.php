		...
		<table id="example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td><?php echo $row['total_loan']; ?> Ksh</td>
	                <td><?php echo $row['installments']; ?></td>
	                <td><?php echo $row['emi_loan']; ?> Ksh/month</td>
	                <td><?php echo $row['amount_paid']; ?> Ksh</td>
	                <td><?php echo $row['amount_remain']; ?> Ksh</td>
	                <td><?php //echo $row['fine']; ?> Ksh</td>
