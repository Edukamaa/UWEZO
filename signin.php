  ...
  <div class="container">
    <form class="form-signin" action="" method="POST">
      <div class="text-center mb-4">
        <img class="mb-2" src="images/profit back 3.jpeg" alt="" width="220" height="72">
    ...
    <div class="row">
         ...
         <table class="table table-bordered" style="background:#fff">
            <tr>
              ...
              <tr>
                <tr>
                  <td>E-mail: </td>
                  <td>nelsonkariuki@gmail.com</td>
                  <td>E-mail: </td>
                  <td>kariukikamau@gmail.com</td>
                  <td>E-mail: </td>
                  <td>marywanjiru@gmail.com</td>
                </tr>
                <tr>
                  <td>Password: </td>
                  <td>123</td>
      ...
      <div class="col-md-12 ">
        <p class="text-muted text-center">Developed by &copy; <a href="https://github.com/Edu-Kamaa">Edu Kamaa @ Github</a> - 2023 </p></div>
    </div>
    </div>
  </body>
</html>
