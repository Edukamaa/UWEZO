...
?>
  ...
  <?php 
   ...
   ?>
        ...
        <h5 class="card-title p-3 bg-info text-white rounded">project details</h5>
        <div class="container">
          <?php
              if (isset($inserted)){
          ?>
          ...
          <form action="" method="post" name="myform" id="myform" >
            ...
            <div class="form-group row">
                <label  class="text-right col-2 font-weight-bold col-form-label">Used Amount</label>
                 <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label  class="text-right col-2 font-weight-bold col-form-label">Project Name</label>
                 <div class="col-sm-9">
                  <input type="text" name="property_name" class="form-control"  placeholder="Project name" required>
                 </div>
            </div> 
              
            <div class="form-group row">
                <label  class="text-right col-2 font-weight-bold col-form-label">Project Details</label>
                 <div class="col-sm-9">
                 <textarea name="project_details" class="form-control" id="" cols="30" rows="10" required></textarea>
                 </div>
            </div> 
